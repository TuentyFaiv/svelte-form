...
<Tabs>
  <TabItem label="Definition">
    ...
    | base | [`FaivBaseTheme`](/reference/#faivbasetheme) \| `undefined` | Global base CSS variables shared between light and dark themes. |
...
<Tabs>
  ...
  <TabItem label="Usage">
    ```typescript
    import type { FaivBaseTheme } from "@tuentyfaiv/svelte-form";

    const base: FaivBaseTheme = {
      // ... base
    };
    ```
  </TabItem>
